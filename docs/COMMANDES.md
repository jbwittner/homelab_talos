...
Commandes générales pour gérer les clusters Talos de ce dépôt. Pour les IPs, noms de fichiers et procédures spécifiques, voir le README du cluster ([kalecgos](../kalecgos/README.md)).
